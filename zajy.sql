...
INSERT INTO `menu` VALUES (1,'admin','用户中心','/home',0,'tools',1),(2,'admin','人员管理','/user',0,'user',2),(3,'admin','志愿活动','/sys/role',0,'postcard',3),(4,'admin','积分商城','/mall',0,'goods',4),(5,'admin','学习资料','/study',0,'present',5),(6,'index','志愿者专区','/vol/list',0,'user',6),(7,'index','活动报名','/vol/my',6,'notebook-2',1),(8,'index','积分兑换','/vol/ranking',6,'data-line',2),(9,'admin','商品添加','/dashboard',4,'tickets',1),(10,'admin','兑换管理','/dashboard/logs',4,'document-che',2);
